...
if __name__ == '__main__':
    ...
    yolo_test_args = {
     ...
     "anchors_path": 'model_data/yolo1_anchors.txt',
     "classes_path": 'model_data/voc1_classes.txt',
     "score" : 0.1,
     "iou" : 0.3,
    ...
    # 图片变视频
    output_dir='unilever/'
    output_path= os.path.join(output_dir, 'unilever/allan/%s.jpg')                       # 输入图片存放位置
    output_video_file = 'unilever/fps20.mp4' # 输入视频保存位置以及视频名称
